...
static UART_HandleTypeDef *g_emm_uart = &huart2;
...
/* Route the vendor sample API through the selected UART. */
#define HAL_UART_Transmit_DMA(_huart, _pData, _size) HAL_UART_Transmit(g_emm_uart, (uint8_t *)(_pData), (_size), 100U)
