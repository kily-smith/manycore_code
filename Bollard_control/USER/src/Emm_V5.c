...
/* Route the vendor sample API through USART6 in this project. */
#define HAL_UART_Transmit_DMA(_huart, _pData, _size) HAL_UART_Transmit(&huart6, (uint8_t *)(_pData), (_size), 100U)
