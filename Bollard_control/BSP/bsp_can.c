...
void HAL_CAN_RxFifo0MsgPendingCallback(CAN_HandleTypeDef *hcan)
{
  ...
  HTMotor_OnCanRx(HAL_GetTick(), (uint16_t)rx_header.StdId, rx_header.DLC, rx_data);
  ...
  {
    can_cnt = 0;
    HAL_GPIO_TogglePin(LED_G_GPIO_Port, LED_G_Pin); // green led blink indicate can communication successful
  }
}
